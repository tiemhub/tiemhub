...
| -------- | -------------------------------------------------------------- | -------- | ------------------------------------------------------------ |
| Paper    | Latent Diffusion Model을 활용한 워터마킹 기술 서베이 논문 작성 | 2024.10 | Latent Diffusion Models for Image Watermarking: A Review of Recent Trends, and Future Directions (제출)          |
